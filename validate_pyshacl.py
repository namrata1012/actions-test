...
def validate_ttl(data_graph):
    ...
    data_g = Graph().parse(data=data_graph, format="turtle")

    print('validating data')
    result = validate(data_g, shacl_graph=shapes_g, inference='rdfs', serialize_report_graph=True)
